...
export function mergeSaves(a={},b={}){
 ...
 return {...a,...b,bag:[...fish.values()].sort((x,y)=>(+y.time||0)-(+x.time||0)),medals:{...a.medals,...b.medals},visited:{...a.visited,...b.visited},cupWins:{...a.cupWins,...b.cupWins},cupRewards:rewards,score:Math.max(+a.score||0,+b.score||0,Object.values(rewards).reduce((s,n)=>s+n,0))};
}
