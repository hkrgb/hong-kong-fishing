...
function showTackle(){
 const w=wallet();modal('海港釣具店 · $'+w.money,'<div class="shopScene" style="background-image:url('+shopAsset('tackle-shop')+')"><div class="shopDisplay"><img src="'+shopAsset('bait-kit')+'" alt="基本、高級與最高級魚餌"><p>每次拋竿消耗一份，包括空手收回或斷線。</p></div><div class="shopOffers"></div></div>');
